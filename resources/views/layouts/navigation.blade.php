            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:ml-10 sm:space-x-8">
                    <a href="{{ route('dashboard') }}" 
                       class="inline-flex items-center px-1 pt-1 {{ request()->routeIs('dashboard') ? 'border-b-2 border-indigo-400 text-gray-900' : 'text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                        Dashboard
                    </a>
                    ...
                    @else
                        ...
                        <a href="{{ route('therapists.index') }}" 
                           class="inline-flex items-center px-1 pt-1 {{ request()->routeIs('therapists.index') ? 'border-b-2 border-indigo-400 text-gray-900' : 'text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                            Find Therapist
                        </a>
                    @endif
                </div>
